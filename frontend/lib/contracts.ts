...
export const TRUSTFLOW_ABI = [
  ...
  },
  {
    ...
    "outputs": [
      ...
      {
        "internalType": "enum TrustFlow.AgreementStatus",
        "name": "status",
        "type": "uint8"
      },
      {
    ...
    "outputs": [
      {
        ...
        "internalType": "struct TrustFlow.Agreement",
        "name": "",
        "type": "tuple"
      }
    ],
    ...
    "outputs": [
      {
        "components": [
          ...
          {
            "internalType": "enum TrustFlow.MilestoneStatus",
            "name": "status",
            "type": "uint8"
          },
          {
        ...
        "internalType": "struct TrustFlow.Milestone",
        "name": "",
        "type": "tuple"
      }
    ],
    ...
    "outputs": [
      {
        ...
        "internalType": "struct TrustFlow.TrustProfile",
        "name": "",
        "type": "tuple"
      }
    ],
